...
function renderPrivacyPanel(hasData) {
  return h("div.nm-surface.ap-privacy", {},
    ...
    h("p.ap-privacy-lead", {},
      ...
      "共有操作を行った場合に限り、アーキタイプとWork Style、画像では性格から作った一言も共有先へ渡ります。採点はこのブラウザの中だけで行います。回答が残るのはこの端末の中だけなので、ほかの端末で見たいときや確実に残したいときは画像で保存してください。"
    ),
    h("details.ap-privacy-details", {},
      ...
      h("ul.ap-privacy-list", {},
        ...
        // 画像には性格から作った一言（修飾語・タグ）も描かれる。リンクと同じ扱いで
        // 「性格は渡しません」と書くと、実際に渡っているものを隠すことになる
        h("li", { text: "共有ボタンを押したときだけ、共有先のアプリへ渡ります。リンクに載るのはアーキタイプとWork Styleの4軸、性格まで答えた人は名前に添える一言（「まわりを立てる」など）です。" }),
        h("li", { text: "画像（Instagram用）には、それに加えて性格タグ（「外向性 高め」など）も入ります。科目・実務・勉強の回答はどちらにも渡しません。" })
      ),
      hasData &&
