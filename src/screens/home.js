  ...
  return h("div.nm-surface.ap-privacy", {},
    ...
    h("details.ap-privacy-details", {},
      ...
      h("ul.ap-privacy-list", {},
        ...
        h("li", { text: "共有ボタンを押したときだけ、共有先のアプリへ渡ります。リンクに載るのはアーキタイプとWork Styleの4軸だけです。" }),
        h("li", { text: "画像（Instagram用）には、それに加えて性格から作った一言（「まわりを立てる」「外向性 高め」など）が入ります。科目・実務・勉強の回答はどちらにも渡しません。" })
      ),
      hasData &&
